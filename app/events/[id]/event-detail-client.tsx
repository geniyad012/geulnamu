...
import { ChevronLeft, Copy, Check, Calendar, MapPin } from "lucide-react"
      ...
      <div className="min-h-screen bg-gray-50 pb-32">
        <header className="sticky top-0 z-50 bg-white border-b border-gray-200">
          <div className="max-w-[430px] mx-auto flex items-center justify-between px-4 py-3">
            ...
            <h1 className="text-xl font-bold text-black">이벤트 상세</h1>
            <div className="w-9" />
          </div>
        </header>
          ...
          <div className="max-w-[430px] mx-auto">
            <button
              ...
              className={`w-full py-4 text-lg font-bold rounded-xl transition-all ${
                canApply
                  ? "bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white shadow-lg active:scale-[0.98]"
